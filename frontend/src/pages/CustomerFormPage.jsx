      ...
      <div className="space-y-4 max-w-4xl pb-28">
        <div className={`${cardCls} p-4`}>
          ...
          <div className="flex flex-wrap gap-4">
            <FormField className="w-full sm:w-[380px]" label="Company Name" required error={errors.company_name} counter={{ value: draft.company_name.length, max: 100 }}>
            ...
            <FormField className="w-full sm:w-[220px]" label="GST Number" error={errors.gst_number} hint="15 characters">
            ...
            <FormField className="w-full sm:w-[180px]" label="PAN Number" error={errors.pan_number} hint="10 characters">
            ...
            <FormField className="w-full sm:w-[220px]" label="Company Type">
            ...
            <FormField className="w-full sm:w-[260px]" label="Website" error={errors.website}>
        ...
        <div className={`${cardCls} p-4`}>
          ...
          <div className="flex flex-wrap gap-4">
            <FormField className="w-full sm:w-[260px]" label="Contact Person" required error={errors.contact_person}>
            ...
            <FormField className="w-full sm:w-[220px]" label="Designation" error={errors.designation}>
            ...
            <FormField className="w-full sm:w-[190px]" label="Mobile Number" required error={errors.mobile}>
            ...
            <FormField className="w-full sm:w-[190px]" label="Alternate Mobile" error={errors.alternate_mobile}>
            ...
            <FormField className="w-full sm:w-[300px]" label="Email" required error={errors.email}>
            ...
            <FormField className="w-full sm:w-[300px]" label="Alternate Email" error={errors.alternate_email}>
        ...
        <div className={`${cardCls} p-4`}>
          ...
          <div className="flex flex-wrap gap-4">
            <FormField className="w-full sm:w-[420px]" label="Address Line 1" required error={errors.address_line_1} counter={{ value: draft.address_line_1.length, max: 150 }}>
            ...
            <FormField className="w-full sm:w-[420px]" label="Address Line 2" error={errors.address_line_2}>
            ...
            <FormField className="w-full sm:w-[220px]" label="City" required error={errors.city}>
            ...
            <FormField className="w-full sm:w-[220px]" label="State" required>
              <SearchableSelect value={draft.state} onChange={(val) => setDraft((d) => ({ ...d, state: val }))} placeholder="Select state" options={INDIAN_STATES} />
            </FormField>
            <FormField className="w-full sm:w-[180px]" label="Country" required>
            ...
            <FormField className="w-full sm:w-[150px]" label="Pincode" required error={errors.pincode}>
        ...
        <div className={`${cardCls} p-4`}>
          ...
          <div className="flex flex-wrap gap-4">
            <FormField className="w-full sm:w-[260px]" label="Customer Type">
            ...
            <FormField className="w-full sm:w-[260px]" label="Industry">
            ...
            <FormField className="w-full" label="Notes" error={errors.notes} counter={{ value: draft.notes.length, max: 500 }}>
